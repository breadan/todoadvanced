...
export const ToDo = ({ todo,handleDeleteConfirm }) => {
  ...
  const handelCheck = () => {
    ...
    const updateToDo = lisdToDo.map((t) => {
      if (t.id == todo.id) {
        ...
        if (t.isCompleted === true) {
          toast.handleClose("Task Completed Success");
        } else {
          toast.handleClose("Task Didn't Completed");
        }
      }
    ...
    // toast.handleClose("Task Edit Success");
  };
  ...
  function handleDeleteConfirm  () {
    //toast
    toast.handleClose("Task Deleted Success");
    setShowDeleteModal(false);
  ...
  const shareUrl = "tutorend.com";
  const currentPageUrl = "https://twitter.com/i/flow/single_sign_on";
  //=======share Modal
